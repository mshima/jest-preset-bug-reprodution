...
describe('Attachment e2e test', () => {
  ...
  it('should load Attachments', async () => {
    ...
    expect(await attachmentComponentsPage.getTitle()).to.eq('jhipsterApp.attachment.home.title');
  ...
  it('should load create Attachment page', async () => {
    ...
    expect(await attachmentUpdatePage.getPageTitle()).to.eq('jhipsterApp.attachment.home.createOrEditLabel');
  ...
  it('should delete last Attachment', async () => {
    ...
    expect(await attachmentDeleteDialog.getDialogTitle()).to.eq('jhipsterApp.attachment.delete.question');
