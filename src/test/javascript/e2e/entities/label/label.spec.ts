...
describe('Label e2e test', () => {
  ...
  it('should load Labels', async () => {
    ...
    expect(await labelComponentsPage.getTitle()).to.eq('jhipsterApp.label.home.title');
  ...
  it('should load create Label page', async () => {
    ...
    expect(await labelUpdatePage.getPageTitle()).to.eq('jhipsterApp.label.home.createOrEditLabel');
  ...
  it('should delete last Label', async () => {
    ...
    expect(await labelDeleteDialog.getDialogTitle()).to.eq('jhipsterApp.label.delete.question');
