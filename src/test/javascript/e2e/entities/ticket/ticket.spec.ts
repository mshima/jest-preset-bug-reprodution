...
describe('Ticket e2e test', () => {
  ...
  it('should load Tickets', async () => {
    ...
    expect(await ticketComponentsPage.getTitle()).to.eq('jhipsterApp.ticket.home.title');
  ...
  it('should load create Ticket page', async () => {
    ...
    expect(await ticketUpdatePage.getPageTitle()).to.eq('jhipsterApp.ticket.home.createOrEditLabel');
  ...
  it('should delete last Ticket', async () => {
    ...
    expect(await ticketDeleteDialog.getDialogTitle()).to.eq('jhipsterApp.ticket.delete.question');
